...
def ANN(x,submatrices):
	...
	for i in range(len(layers)-1):
		index=2*i
		# print(submatrices[index].shape,z1.shape,submatrices[index+1].shape)
...
po=np.random.uniform(-1,1.,size=NFIT)
